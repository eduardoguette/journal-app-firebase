...
export const UserMenu = () => {
  ...
  return (
    <motion.div layout className='relative group' onHoverEnd={() => setShowMenu(!showMenu)} onHoverStart={() => setShowMenu(!showMenu)}>
      ...
      <AnimatePresence>
        {showMenu && (
          <motion.ul
            ...
            className='absolute -bottom-[160%] hidden group-hover:flex  flex-col gap-1 pt-2 pb-1 bg-white border rounded shadow-md position right-[3%] w-max'
          >
            <li>
